...
function interlockingRangeBar(num) {
    ...
    document.getElementById(colorLabel[num] + "_num").value =
        colorProperties[num];
}
function interlockingInput(num) {
    ...
    document.getElementById(toCamelcase(colorLabel[num])).value =
        colorProperties[num];
}
...
function copyColorCode() {
    ...
    setTimeout(() => alert("Copied color code!!\n" + colorCode), 100);
}
// 関数管理。
